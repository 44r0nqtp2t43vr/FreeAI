...
class HomeScreen():
    def __init__(self, screen):
        ...
        # import components
        awaken_button_font = pygame.font.Font('assets/fonts/KenneyHighSquare.ttf', 60)
        self.awaken_button = btns.HomeButton(self.screen_width//2, (self.screen_height//4)*3 - 40, 200, 60, awaken_button_font, "Awaken", (255, 255, 255))

        # initialize sprite group
        self.home_group = pygame.sprite.Group(self.awaken_button)
